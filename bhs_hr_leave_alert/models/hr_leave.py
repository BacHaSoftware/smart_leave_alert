...
class BHSHrLeave(models.Model):
    ...
    def create(self, vals_list):
        ...
        for values in vals_list:
            ...
            time_off_type = self.env.ref('hr_holidays.leave_type_paid_time_off')
            if leave_type.id == time_off_type.id:
                leave_allocation = float(
                    user.employee_id.allocation_remaining_display) if user.employee_id.allocation_remaining_display else 0.0
